(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-checkout-checkout-module~modules-login-login-module~modules-menu-menu-module"], {
    /***/
    "9YtQ":
    /*!***************************************************************************************!*\
    ...
    /***/
    function YtQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
          ...
          value: function exec(str, regex) {
            ...
            if (regex instanceof RegExp) {
              ...
              return regex.reduce(function (res, item) {
                return !!res ? res : _this2.exec(str, item);
              }, null);
            } else {
              return null;
            }
        ...
        _createClass(DeviceDetectorService, [{
          ...
          value: function setDeviceInfo() {
            ...
            mappings.forEach(function (mapping) {
              _this3[mapping.prop] = Object.keys(Constants[mapping["const"]]).reduce(function (obj, item) {
                if (Constants[mapping["const"]][item] === 'device') {
                  // hack for iOS 13 Tablet
                  if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["isPlatformBrowser"])(_this3.platformId) && (!!_this3.reTree.test(_this3.userAgent, TABLETS_RE[iPad]) || navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 1)) {
                    obj[Constants[mapping["const"]][item]] = iPad;
                    return Object;
                  }
                }

                obj[Constants[mapping["const"]][item]] = _this3.reTree.test(ua, Constants["".concat(mapping["const"], "_RE")][item]);
                return obj;
              }, {});
            });
            mappings.forEach(function (mapping) {
              _this3[mapping.prop] = Object.keys(Constants[mapping["const"]]).map(function (key) {
                ...
                if (mapping.prop === 'device' && previousValue === Constants[mapping["const"]].ANDROID) {
                  ...
                  return _this3[mapping.prop][currentValue] ? currentValue : previousValue;
                } else {
                  return previousValue === Constants[mapping["const"]].UNKNOWN && _this3[mapping.prop][currentValue] ? currentValue : previousValue;
                }
          ...
          value: function isMobile() {
            ...
            var match = Object.keys(MOBILES_RE).find(function (mobile) {
              return _this4.reTree.test(userAgent, MOBILES_RE[mobile]);
            });
            return !!match;
          }
          /**
          ...
          value: function isTablet() {
            ...
            var match = Object.keys(TABLETS_RE).find(function (mobile) {
              return !!_this5.reTree.test(userAgent, TABLETS_RE[mobile]);
            });
            return !!match;
          }
          /**
      ...
      DeviceDetectorService.ɵprov = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"])({
        factory: function DeviceDetectorService_Factory() {
          return new DeviceDetectorService(Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"])(_angular_core__WEBPACK_IMPORTED_MODULE_0__["PLATFORM_ID"]));
        },
    ...
    function GOjK(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(http, deviceDetectorService, router, alertController, storage) {
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      return this.alertController.create({
                        ...
                        header: 'Atención!',
                        message: "Est\xE1s entrando desde un dispositivo para el cual no est\xE1 desarrolada esta plataforma. Por favor entra desde tu dispositivo m\xF3vil.",
                        buttons: [{
                          text: 'Entendido',
                          role: 'cancel',
                          cssClass: 'secondary',
...
//# sourceMappingURL=default~modules-checkout-checkout-module~modules-login-login-module~modules-menu-menu-module-es5.js.map