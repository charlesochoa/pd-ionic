...
let AuthService = class AuthService {
    constructor(http, deviceDetectorService, router, alertController, storage) {
        this.http = http;
    ...
    login(email) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}ddp_users/`, { user: { email, username: email } });
    }
    getUsers() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}users/`);
    }
    getUser(pk) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}ddp_users/${pk}/`);
    }
    getLocalUser() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            console.log('Trying to get localUser');
            const pk = yield this.storage.get('pk');
            if (pk) {
                const angularShape = yield this.storage.get('angularShape');
                const email = yield this.storage.get('email');
                const cartPk = yield this.storage.get('cartPk');
    ...
    getTransaction() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const t = yield this.storage.get('t');
            return t;
        });
    }
    setLocalUser(u) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.set('email', u.user.email);
            yield this.set('angularShape', u.angularShape);
            yield this.set('pk', u.pk);
            yield this.set('cartPk', u.cartPk);
        });
    }
    set(key, value) {
        var _a;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield ((_a = this._storage) === null || _a === void 0 ? void 0 : _a.set(key, value));
        });
    }
    clear() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
//# sourceMappingURL=default~modules-checkout-checkout-module~modules-login-login-module~modules-menu-menu-module-es2015.js.map